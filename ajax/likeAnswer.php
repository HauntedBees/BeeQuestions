...
$answerData = $sql->QueryRow("SELECT a.sAnswer, u.sDisplayName, u.cID AS uID, u.cID64 AS uID64 FROM bq_answers a INNER JOIN bq_users u ON a.xUser = u.cID WHERE a.cID = :answerId", ["answerId" => $answerID]);
$query = <<<EOT
