...
$questionData = $sql->QueryRow("SELECT q.xAnswer, q.sQuestion, a.sAnswer, u.cID AS uID, u.cID64 AS uID64 FROM bq_questions q INNER JOIN bq_answers a ON q.xAnswer = a.cID INNER JOIN bq_users u ON q.xUser = u.cID WHERE q.cID = :questionId", ["questionId" => $questionId]);
$query = <<<EOT
