...
$query = <<<EOT
	INSERT INTO bq_notifications (xUser, sTemplate, sToken1, sToken2, sToken3, sToken4, dtPosted, bDismissed) VALUES 
		(:you, 'youLikedQuestion.html', :qURL, :q, :theirURL, :theirName, NOW(), 1),
		(:them, 'likedQuestion.html', :qURL, :q, :yourURL, :yourName, NOW(), 0)
EOT;
...
$sql->Query($query, [
	"you" => $yourID, 
	"them" => $theirID, 
	"qURL" => "viewAnswer.php?answer=".Base64::to64($questionData["aHexID"])."#q".$_POST["id"], 
